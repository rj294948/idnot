...
async function createSampleProducts() {
    const products = [
        ...
        },
        {
            ...
            stone_name: 'Natural Sandstone',
            category: 'outdoor',
            type: 'Natural',
            price: '£35.00',
            price_unit: 'sqft',
            image: 'https://images.unsplash.com/photo-1600585154340-2e5db6e509e9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80',
            description: 'Natural sandstone pavers for outdoor landscaping and pathways.',
            color: 'Multi-color',
            thickness: '30-40 mm',
            size: 'Pavers',
            finish: 'Natural',
            usage: 'Outdoor Pavement, Landscaping',
            water_absorption: '4-5%',
            density: '2.2-2.4 g/cm³',
            compressive_strength: '1500-1800 kg/cm²',
            created_at: serverTimestamp(),
            status: 'active'
        }
    ];
